...
function user_screen() {
  ...
  var filtersArray = [["All",""],["Users","user"], ["Admins","admin"],["Supervisers","super"]]
  const filterSet=(e)=>{
      e.preventDefault();
  ...
  const handleDelete=(e)=>{
      ...
      setAlertStyle({
        variantHead: 'danger',
        heading: 'Warning',
        text: `Are you trying to delete information about ${e.name}?`,
      ...
      <div className="w-full max-w-[1000px] flex flex-row justify-center items-center flex-wrap">
        <h3 className="w-full xs:text-md sm:text-xl  text-center">
          ...
          >
            ...
            >
              <div className="w-auto rounded-md border bg-main-bg  p-0.5 m-1">
